...
import com.exmples.restore.StateRestoreHttpReporter;
import com.clients.producer.MockDataProducer;
import com.model.CustomerTransactions;
import com.model.StockTransaction;
import com.util.serde.StreamsSerdes;
import com.webserver.InteractiveQueryServer;
...
public class StockPerformanceInteractiveQueryApplication {
    ...
    private static Properties getProperties() {
        ...
        props.put(StreamsConfig.consumerPrefix(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG), Collections.singletonList(com.exmples.interceptors.StockTransactionConsumerInterceptor.class));
        return props;
    }
}
